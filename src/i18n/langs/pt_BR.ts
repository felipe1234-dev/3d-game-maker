const pt_BR = {
    ...
    "AO Map": "Mapa de AO",
    "AO Map intensity": "Intensidade do Mapa AO",
    "MatCap Map": "Mapeamento Esférico do Amb.",
    "Light map": "Mapa de Iluminação",
    "Light map intensity": "Intensidade do Mapa de Iluminação",
    "Emissive Map": "Mapa de Emissão",
    "Displacement Map": "Mapa de Deslocamento",
    "Displacement bias": "Viés de Deslocamento",
    "Displacement scale": "Escala de Deslocamento",
    "Normal Map": "Mapa Normal",
    "Normal scale (x)": "Escala Normal (x)",
    "Normal scale (y)": "Escala Normal (y)",
    "Clearcoat normal map": "Mapa Normal do Verniz",
    "Clearcoat normal scale (x)": "Escala do Vérniz (x)",
    "Clearcoat normal scale (y)": "Escala do Vérniz (y)",
    "Alpha map": "Mapa Alpha",
    "Gradient map": "Mapa de Gradiente",
    "Metalness map": "Mapa da Metalicidade",
    "Roughness map": "Mapa de Aspereza",
    "Bumping map": "Mapa de Bumping",
